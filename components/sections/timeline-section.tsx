        ...
        <div className="max-w-6xl mx-auto space-y-8">
          {items.map((item, index) => (
            ...
            >
              ...
              {/* Card */}
              <div className="relative flex-1 overflow-hidden rounded-2xl h-[140px] md:h-[160px] group">
                {/* Background Image */}
                ...
                <div className="relative z-10 h-full flex items-center px-4 md:px-12">
                  ...
                  {/* Step Number Badge */}
                  <div className="flex items-center mr-6 md:mr-10 flex-shrink-0">
                    <span className="text-3xl md:text-4xl font-bold text-white italic mr-4 uppercase">STEP</span>
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center border border-white/20">
                      <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-cyan-400/20 backdrop-blur-sm flex items-center justify-center">
                  ...
                  {/* Text Content */}
                  <div className="flex-1 pl-6 md:pl-10 py-2 border-l border-white/20">
                    <h4 className="text-lg md:text-xl font-medium text-white leading-snug drop-shadow-md">
                      {item.description}
                    </h4>
                  </div>
                </div>
